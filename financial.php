    ...
    <div class="main-panel">
        ...
        <div class="top-header">
            ...
            <div style="display: flex; gap: 10px; flex-wrap:wrap; margin-right: 20px;">
                ...
                <button onclick="openModal('billsModal')" class="btn-action btn-enter-bills"><i class="fa-solid fa-cash-register"></i> Enter Bills</button>
                <button onclick="openModal('checkModal')" class="btn-action btn-issue-check"><i class="fa-solid fa-money-check"></i> Check Voucher</button>
        ...
        <div class="modal-content modal-lg">
            ...
            <form method="POST" style="padding: 25px;">
                ...
                <div style="margin-top: 15px; text-align: right; border-top: 1px solid var(--gray-border); padding-top: 15px;">
                    ...
                    <button type="submit" name="enter_bill" style="background:#f59e0b; color:white; border: none; padding: 10px 24px; border-radius: 8px; font-weight: 600; cursor: pointer;"><i class="fa-solid fa-file-invoice-dollar"></i> Save & Generate Voucher</button>
                </div>
            </form>
        </div>
    </div>
